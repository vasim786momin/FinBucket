 ...
 */
public class BuisnessLoanListAdapter extends RecyclerView.Adapter<BuisnessLoanListAdapter.ViewHolder>
{

    private List<BuisnessLoanData> buisnessLoanDataList;
    Context context;

    public BuisnessLoanListAdapter(Context context,List<BuisnessLoanData> buisnessLoanDataList )
    {
        super();
        this.context = context;
        this.buisnessLoanDataList = buisnessLoanDataList;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        final BuisnessLoanData item = buisnessLoanDataList.get(position);
    ...
    public int getItemCount() {
        return buisnessLoanDataList.size();
    }
