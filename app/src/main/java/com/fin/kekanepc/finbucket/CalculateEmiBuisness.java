...
public class CalculateEmiBuisness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculate_emi_buisness);
        ...
        eDob.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus == true)
                    new DatePickerDialog(CalculateEmiBuisness.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(b==true)
                        {
                            ...
                            Intent i = new Intent(CalculateEmiBuisness.this, CalculateEmiBuisnessFinal.class);
