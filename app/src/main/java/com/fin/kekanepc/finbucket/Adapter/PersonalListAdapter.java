...
public class PersonalListAdapter  extends RecyclerView.Adapter<PersonalListAdapter.ViewHolder>
{
    ...
    private List<PersonalLoanData> personalLoanDataList;
    Context context;

    public PersonalListAdapter(Context context,List<PersonalLoanData> personalLoanDataList )
    {
        super();
        this.context = context;
        this.personalLoanDataList = personalLoanDataList;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        final PersonalLoanData item = personalLoanDataList.get(position);
    ...
    public int getItemCount() {
        return personalLoanDataList.size();
    }
