 ...
 */
public class MortageLoanListAdapter extends RecyclerView.Adapter<MortageLoanListAdapter.ViewHolder>
{

    private List<MortageLoanData> mortageLoanDataList;
    Context context;

    public MortageLoanListAdapter(Context context,List<MortageLoanData> mortageLoanDataList )
    {
        super();
        this.context = context;
        this.mortageLoanDataList = mortageLoanDataList;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        final MortageLoanData item = mortageLoanDataList.get(position);
    ...
    public int getItemCount() {
        return mortageLoanDataList.size();
    }
